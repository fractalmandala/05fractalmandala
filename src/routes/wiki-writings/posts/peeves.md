...
tags:
  ...
  - opinion
group: knowledge
image: https://rnfvzaelmwbbvfbsppir.supabase.co/storage/v1/object/public/gallery/posts/i-peeves.webp
description: Discussing various minor and major peeves with modern technology, from the inconveniences of small buttons on mobile screens to the hassles of constant updates and unintuitive user interface changes.
date: 2023-08-25
supergroup: writings
kind: posts
---
...
- Sep 2023, new forced update to Whatsapp app on Android. The buttons to select between emojis, GIFs and stickers were previously at bottom of the keypad. Post-update they are now on the top of the keypad! What kind of idiotic decision-making goes into completely inverting the UI your userbase is accustomed to?

- Dec 2024, the same shit is now pulled by Figma. Whole overhaul of their UI such that same settings, configurations, toggles are all now in different places. Changes as radical as moving a main UI component from top left of screen to bottom center. Why even the fuck?
