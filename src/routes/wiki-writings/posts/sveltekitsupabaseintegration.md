...
tags:
  ...
  - supabase
group: webdev
image: https://rnfvzaelmwbbvfbsppir.supabase.co/storage/v1/object/public/gallery/posts/i-supa.webp
description: An informative guide on securely integrating Supabase with SvelteKit, focusing on best practices for handling secret keys and ensuring data security in web applications.
date: 2022-02-22
supergroup: webdev
kind: posts
---
...
Well, that’s it then. In this way you can integrate Supabase with Sveltekit. [Supabase](https://supabase.com/docs/reference/javascript/introduction) has great documentation on how to fetch data in different ways and filters.