---
title: Whiskey or Whisky
tags:
  - whiskey
group: writings
supergroup: writings
image: https://rnfvzaelmwbbvfbsppir.supabase.co/storage/v1/object/public/gallery/posts/whiskeyorwhisky.webp
description: Explores the historical and geographical origins of the differing spellings of 'whisky' and 'whiskey,' tracing its roots from Gaelic words and examining how countries like the U.S., Ireland, Scotland, and Japan have adopted distinct spellings.
date: 2014-02-21
kind: posts
---

Malt aficionados already know that single malts are almost exclusively spelled as 'whisky' and not 'whiskey.' But what is the difference, and why is it so important?
...
Today, the general rule is to use the spelling as the spirit's country of origin. Thus, even an American would call it Laphroaig whisky, while a Scot would say Jameson Irish whiskey. I came across an interesting mnemonic for this:
