...
tags:
  ...
  - snippets
group: webdev
image: https://rnfvzaelmwbbvfbsppir.supabase.co/storage/v1/object/public/gallery/posts/i-hoversinsvelte.webp
description: A guide to implementing toggle and hover functions in Sveltekit, illustrating basic interactivity and animation techniques for enhancing user experience in web design.
date: 2023-02-04
supergroup: webdev
kind: posts
---
...
Let’s assume we have a _div_ class named ‘icon.’ We want this to be invisible on default, but if user mouse hovers over another class named ‘select,’ then we want ‘icon’ to be visible.
