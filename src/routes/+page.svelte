...
<div class="page-shell wiki-home">
    <div class="box-one">
        <p>
            Welcome to <span class="themed">Fractal Mandala</span>, a knowledge base and digital garden by Amritanshu Pandey.
        </p>
        <p>
        ...
        <p>
            The site also features my two ongoing creative projects. One is The Janapada, a historical fiction project set in ancient Bharata. The other is Thea, a science fiction project.
        </p>
    </div>
    <div class="box-one">
        <h2>My Writings</h2>
